			...
			<div class="header-nav">
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
					    ...
					    <a class="navbar-brand" href="index.html"><img src="../images/Business_Vote_logo.png" style="width: 79px;"></a>
					</div>
										<!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li class="vr-bounce-to-bottom"><a href="../admin/index.php">Inicio</a></li>
                            <li class="hvr-bounce-to-bottom active"><a href="../php/form-registro-candidato.php">Inscribir candidato</a></li>
...
<!-- //header -->
	...
	<div class="about">
		<div class="container">
			<p class="eum">Por favor ingrese los datos solicitados a continuación , para inscribir un candidato .</p>
